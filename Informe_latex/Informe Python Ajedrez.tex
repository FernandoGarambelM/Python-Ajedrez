...
draw(rock)
	...
	\begin{itemize}
		...
		\item \url{https://flip.com/s/DBLovQ25eDFg}	
	\end{itemize}
	\clearpage
	\section{Ejercicios}
	\begin{itemize}
...
\section{Ejercicios}
	...
	\end{figure}
	\begin{itemize}
		\item Quinto ejercicio
	\end{itemize}
	\lstinputlisting[language=Python, caption={Código del Ejercicio2e},numbers=left,]{src/Ejercicio2e.py}
	\begin{itemize}
		\item Resultado
	\end{itemize}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\textwidth,keepaspectratio]{img/Ejercicio2e.png}
		%\includesvg{img/automata.svg}
		%\label{img:mot2}
		%\caption{Product backlog.}
	\end{figure}
	\begin{itemize}
		\item Sexto ejercicio
	\end{itemize}
	\lstinputlisting[language=Python, caption={Código del Ejercicio2f},numbers=left,]{src/Ejercicio2f.py}
	\begin{itemize}
		\item Resultado
	\end{itemize}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\textwidth,keepaspectratio]{img/Ejercicio2f.png}
		%\includesvg{img/automata.svg}
		%\label{img:mot2}
		%\caption{Product backlog.}
	\end{figure}
	\begin{itemize}
		\item Septimo ejercicio
	\end{itemize}
	\lstinputlisting[language=Python, caption={Código del Ejercicio2g},numbers=left,]{src/Ejercicio2g.py}
	\begin{itemize}
		\item Resultado
	\end{itemize}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\textwidth,keepaspectratio]{img/Ejercicio2g.png}
		%\includesvg{img/automata.svg}
		%\label{img:mot2}
		%\caption{Product backlog.}
	\end{figure}
